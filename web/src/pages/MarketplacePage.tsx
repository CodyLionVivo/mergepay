...
export function MarketplacePage() {
  ...
  const state: LoadState =
    settled ? result.state : 'loading'

  const bounties =
    settled ? result.bounties : []

  const errorDetail =
    settled ? result.errorDetail : ''
        ...
        setResult({
          ...
          errorDetail:
            error instanceof ApiError
              ? error.message
              : 'We could not reach MergePay. Check your connection and try again.',
        })
      })
    ...
    <div className="shell">
      ...
      <section className="hero">
        ...
        <p className="hero__eyebrow">
          {t('The developer bounty marketplace')}
        </p>

        <h1 className="hero__title">
          {t('Good code. Clear rewards.')}
        </h1>

        <p className="hero__lede">
          {t(
            'Find your next contribution. Build through GitHub with rewards funded upfront on Stellar.',
          )}
        </p>
      ...
      <p className="marketplace-network">
        {t(
          'Stellar Testnet - Rewards shown in XLM display units',
        )}
      </p>
        ...
        >
          ...
          {state === 'error' ? (
            ...
            >
              ...
              <h3 className="tasks__state-title">
                {t('Unable to load bounties')}
              </h3>

              <p className="tasks__state-text">
                {t(
                  'MergePay couldn’t reach the service.',
                )}
              </p>
